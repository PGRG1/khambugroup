...
interface CountMap {
  l1: Record<string, number>; // by lower(name)
  l2: Record<string, number>; // by `${l1Lower}>${l2Lower}`
  l3: Record<string, number>; // by `${l1Lower}>${l2Lower}>${l3Lower}`
}
                  ...
                  {isEditing ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="p-1 rounded hover:bg-accent text-muted-foreground hover:text-foreground opacity-0 group-hover:opacity-100"
                        style={{ opacity: 1 }}
                      >
