            ...
            <>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  {selectedInvoice.status !== "cancelled" && <Button size="sm" variant="destructive" onClick={() => { updateInvoiceStatus(selectedInvoice.id, "cancelled"); setDrawerOpen(false); }}>Cancel</Button>}
                </div>
