    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <Card>
        <Table>
          ...
          <TableBody>
            {rows.length === 0 && (
              <TableRow><TableCell colSpan={5} className="text-center text-muted-foreground py-8">No active KPI cards.</TableCell></TableRow>
            )}
            {rows.map(({ card, venueId, existing }) => {
              ...
              return (
                <TableRow key={card.id}>
                  <TableCell className="font-medium">{card.kpi_name}</TableCell>
