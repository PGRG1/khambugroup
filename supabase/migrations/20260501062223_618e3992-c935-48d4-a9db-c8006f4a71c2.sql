-- Add manually_adjusted flag to journal_entries
ALTER TABLE public.journal_entries
  ADD COLUMN IF NOT EXISTS manually_adjusted boolean NOT NULL DEFAULT false;

-- Update rebuild function to skip manually-adjusted entries
...
BEGIN
  ...
  -- Skip manual + manually-adjusted entries
  ...
  LOOP
    -- Skip if a manually-adjusted entry already exists for this source
