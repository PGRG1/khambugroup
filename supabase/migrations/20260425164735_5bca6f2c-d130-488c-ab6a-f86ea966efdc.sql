...
BEGIN
  ...
  -- KPAY = whatever non-cash payment_method maps to (they all point to the same account now)
  ...
  LOOP
    ...
    -- Build per-method memo for the consolidated KPAY line
    ...
    -- Reconcile rounding / unallocated
